            ...
            <div className='partner-details__block'>
                {partner.time_open_weekdays || partner.time_open_saturday || partner.time_open_sunday ?
                    <div className='partner-details__open'>
                        {partner.time_open_weekdays ? <p className='partner-details__open-time'>c {partner.time_open_weekdays} до {partner.time_close_weekdays}</p> : <p></p>}
                        {partner.time_open_saturday ? <p className='partner-details__open-time'>cб: {partner.time_open_saturday} - {partner.time_close_saturday}</p> : <p></p>}
                        {partner.time_open_sunday ? <p className='partner-details__open-time'>воскр: {partner.time_open_sunday} - {partner.time_close_sunday}</p> : <p></p>}
                    </div> : <p></p>
                }
                <button className="partner-details__route-button " onClick={handleRouteButton}>Маршрут</button>
            </div>
        </div>
    );
};
